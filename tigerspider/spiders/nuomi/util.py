...
def get_city_code(city_pname): 
    """获取对应城市的cityCode,同时起到了一定的过滤效果
        ...
        Returns: 
            city_code:  str, 城市id
    """
    return None if city_pname not in _city2code else _city2code[city_pname]
...
def get_subcate_by_category(category): 
    ...
    if category.startswith(u"美食"): 
        ...
        return u"酒店旅游"
    elif category.rfind(u"生活服务") != -1: 
        return u"生活服务"
    elif category.rfind(u"休闲娱乐") != -1: 
        return u"休闲娱乐"
    else: 
        return None
