...
class AttractionItem(Item):
    """用于保存景点的数据结构
    """
    def __init__(self, url, name, play_spend, play_spend_unit, address, tel_phone, open_time,
                 total_score, ticket_info, hot, longitude, latitude, seq_sort, comments, zipcode):
        self.url = url
        self.name = name
