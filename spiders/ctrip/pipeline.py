    ...
    def _store_item(self, item, city_chinese_name):
        ...
        try:
            ...
            if len(self.item_db.execute_query(
                ...
                self.item_db.execute_update(insertsql, {'cityname': city_chinese_name,
                    'hotel_id': item.hotel_code, 'room_id': item.room_id,
                    'roominfo': encodestr, 'rateinfo': "",
            ...
            if len(self.item_db.execute_query(
                ...
                self.item_db.execute_update(updatesql,
                    {'city_code': item.city_code, 'hotel_id': item.hotel_code,
                     'url': build_hotel_url(item.hotel_code), 'info': encodestr,
                ...
                self.item_db.execute_update(insertsql, {'city_code': item.city_code,
                    'hotel_id': item.hotel_code, 'url': build_hotel_url(item.hotel_code),
